...
import "./MoneyMarketFactory.sol";
import "./WETHgateway.sol";
import "./Vault.sol";

contract MoneyMarketBuyRedeem is
    Vault,
    ...
    AutomationCompatibleInterface
{
    ...
    function getbondsByBuyersAddr(address addr)
        external
        view
        returns (uint[] memory)
    {
    ...
    function Bondredemption(uint id) external {
        ...
        require(
            block.timestamp > bondInfo[id].bondMaturityDate,
